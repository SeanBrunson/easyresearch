...
department: "Department of Finance"                # Institute must be defined
...
```{r, fig.height=10.5, fig.width=14, echo=FALSE}
plot(1:10)
```

### Pretty, colorful text

This is the color red: \textcolor{red}{color red}
